...
// - Si llega /cmd_vel, se activa la cinemática diferencial.
// - La corrección de línea recta por sincronía encoder + IMU
//   se actualiza continuamente desde uros_update_motion_command().
//
// =====================================================
