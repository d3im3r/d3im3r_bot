...
//     //bloque de sincronía para avance recto
//     WheelSpeedRefs refs = kinematics_vw_to_wheels(v_m_s, w_rad_s);

//         SyncOutput sync_out = sync_apply_straight_correction(
//         refs.left_rad_s,
//         refs.right_rad_s,
...
//     //control_set_left_ref(refs.left_rad_s);
//     //control_set_right_ref(refs.right_rad_s);
// }
static void cmd_vel_callback(const void * msgin)
{
    const geometry_msgs__msg__Twist * msg =
...
bool uros_init()
{
    ...
    if (rclc_subscription_init_default(
            ...
            &node,
            ROSIDL_GET_MSG_TYPE_SUPPORT(geometry_msgs, msg, Vector3),
            "wheel_refs_rad_s") != RCL_RET_OK) return false;
