...
#define CTRL_LEFT_KI_PWM       9.0f//3.5f
#define CTRL_RIGHT_KI_PWM      9.0f//3.5f
...
#define SYNC_ENC_KP                    0.20f//0.25f
#define SYNC_ENC_MAX_CORR_RAD_S        0.8f//1.0f

// IMU sync
#define SYNC_IMU_ENABLE                true
#define SYNC_IMU_KP                    0.60f//0.35f//2.0f
#define SYNC_IMU_MAX_CORR_RAD_S        0.6f//0.4f//1.0f

// Corrección total
#define SYNC_TOTAL_MAX_CORR_RAD_S      1.0f//0.9f//1.5f
