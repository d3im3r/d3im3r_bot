...
void loop()
{
    ...
    // =================================================
    //
    // Primero se actualizan las velocidades medidas de rueda.
    // Estas velocidades alimentan:
    // - Control PI
    // - Sincronía
    // - Cinemática directa
    // - Odometría
    ...
    // =================================================
    //
    // La IMU se actualiza antes de odometría y sincronía para
    // trabajar con el yaw más reciente disponible.
    //
    // =================================================
    ...
    //
    // IMU:
    // imu_yaw -> theta, si ODOM_USE_IMU_YAW = true
    //
    // Resultado:
    // x, y, theta, v, w
    //
    ...
    // =================================================
    //
    // Se ejecuta después de odometría para que el timer publique
    // el estado más reciente posible.
    //
    // =================================================
    if (g_uros_ok) {
        uros_spin();
    ...
    // =================================================
    // 5. Actualización continua del comando de movimiento
    // =================================================
    //
    // /cmd_vel
    //    ↓
    ...
    // =================================================
    // 6. Control PI incremental y motores
    // =================================================
    control_update();
    motors_update();
